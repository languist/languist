export default {
  ...
  project: {
    ...
    languageList: {
      ...
      'todoCount#zero': 'All done',
      'todoCount#one': 'Todo: {count} phrase',
      'todoCount#other': 'Todo: {count} phrases',
      lastEdited: 'Edited {date}',
      openEditor: 'Open editor',
      uploadSourceFile: 'Upload source file',
      uploadTranslationFile: 'Upload translation file',
      'exportAllFiles#one': 'Export all {count} file',
      'exportAllFiles#other': 'Export all {count} files',
    },
  },
} as const
